...
//   public static final Ultrasonic BACK_LEFT_ULTRASONIC = new Ultrasonic(5, 8);
  ...
  public static final Potentiometer LIFT_VERTICAL_POTENTIOMETER = new AnalogPotentiometer(0, 46.5116, -1.5);
  public static final Potentiometer LIFT_ARM_POTENTIOMETER = new AnalogPotentiometer(1, -1200, 339);//-1233
