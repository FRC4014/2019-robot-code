...
public class RobotMap {
  ...
  public static final DoubleSolenoid BACK_LOW_SOLENOID = new DoubleSolenoid(1, 6);
...
//   public static final Ultrasonic BACK_LEFT_ULTRASONIC = new Ultrasonic(5, 8);
  ...
  public static final Potentiometer LIFT_VERTICAL_POTENTIOMETER = new AnalogPotentiometer(0, 48, -5);
  public static final Potentiometer LIFT_ARM_POTENTIOMETER = new AnalogPotentiometer(1, -1200, 423);//-1233
  public static final Potentiometer LIFT_WRIST_POTENTIOMETER = new AnalogPotentiometer(2, 3600, -1553);
