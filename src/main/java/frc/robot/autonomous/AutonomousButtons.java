...
public class AutonomousButtons {
    public AutonomousButtons (){
        Robot.oi.alignButton.whenPressed(new DriveByDistance(.8, 120));// 90 is a placeholder, we need one for each angle a thing can be at
        Robot.oi.lookButton.whenPressed(new Pivot(90));
