...
public class AutonomousButtons {
    public AutonomousButtons (){
        ...
        Robot.oi.gButton.whenPressed(new PrintPosition());
        ...
        Robot.oi.LowHatch180Button.whenPressed(new AutonomousPrepare(8, 31, 38, 180, true,true));
        ...
        Robot.oi.GrabCargoButton.whenPressed(new AutonomousPrepare(10,23,90,0,false,true));
        ...
        Robot.oi.LowCargo90Button.whenPressed(new AutonomousPrepare(24,43.9,124.3,90,false,true));
        Robot.oi.LowCargo270Button.whenPressed(new AutonomousPrepare(24,43.9,124.3,270,false,true));
