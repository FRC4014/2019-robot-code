...
public class AutonomousButtons {
    public AutonomousButtons (){
        ...
        Robot.oi.GrabCargoButton.whenPressed(new AutonomousPrepare(14.8,10.2,48.2,0,false));
        Robot.oi.LowCargo0Button.whenPressed(new AutonomousPrepare(24,43.9,124.3,0,false));
        Robot.oi.LowCargo90Button.whenPressed(new AutonomousPrepare(24,43.9,124.3,90,false));
        Robot.oi.LowCargo270Button.whenPressed(new AutonomousPrepare(24,43.9,124.3,270,false));
        Robot.oi.MidCargo90Button.whenPressed(new AutonomousPrepare(2.8,208.2,139.3,90,false));
        Robot.oi.MidCargo270Button.whenPressed(new AutonomousPrepare(2.8,208.2,139.3,270,false));
        Robot.oi.HighCargo90Button.whenPressed(new AutonomousPrepare(24,181.5,157.8,90,false));
        Robot.oi.HighCargo270Button.whenPressed(new AutonomousPrepare(24,181.5,157.8,270,false));
    }
}
