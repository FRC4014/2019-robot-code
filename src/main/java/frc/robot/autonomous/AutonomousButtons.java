...
public class AutonomousButtons {
    public AutonomousButtons (){
        ...
        Robot.oi.LowHatch90Button.whenPressed(new AutonomousPrepare(.8, 58, 99, 90, true,true));
        ...
        Robot.oi.MidHatch33125Button.whenPressed(new AutonomousPrepare(24, 74.5, 85, 331.25, true,true));
        ...
        Robot.oi.LowCargo0Button.whenPressed(new AutonomousPrepare(24,83,97,0,false,true));
