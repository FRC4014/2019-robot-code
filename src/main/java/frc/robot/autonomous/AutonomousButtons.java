...
public class AutonomousButtons {
    public AutonomousButtons (){
        Robot.oi.alignButton.whenPressed(new LookPut());// 90 is a placeholder, we need one for each angle a thing can be at
        Robot.oi.lookButton.whenPressed(new AlignByVision(0));
